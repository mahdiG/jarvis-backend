...
func Setup(app *fiber.App) {
	...
	notes.Patch("/", controllers.UpdateNotes)
	notes.Delete("/", controllers.SoftDeleteNotes)
	notes.Get("/trash", controllers.GetTrashNotes)
	notes.Patch("/trash", controllers.RestoreNotes)
	notes.Delete("/trash", controllers.HardDeleteNotes)
